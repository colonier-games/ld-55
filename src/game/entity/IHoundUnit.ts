...
export const UNIT_HOUND_BASE_HP = 1;
export const UNIT_HOUND_BASE_AP = 1;
...
export interface IHoundUnit extends IMeleeUnit { }
...
export function createHoundUnit(
    ...
    return {
        ...
        attackAnimationStartTime: UNIT_HOUND_ATTACK_ANIMATION_START,
        attackRange: UNIT_HOUND_ATTACK_RANGE,
    };
}
